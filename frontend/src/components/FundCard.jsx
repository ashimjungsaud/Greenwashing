...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-color-0 cursor-pointer" onClick={handleClick}>
      <img src={image} alt="fund" className="w-full h-[220px] object-cover rounded-[15px]" />
      ...
      <div className="flex flex-col p-4">
        ...
        <div className='flex justify-start mt-[15px] gap-4'>
          <button className="font-epilogue font-semibold text-[22px] text-[#b2b3bd] leading-[22px]"><FaRegThumbsUp /></button>
          <button className="font-epilogue font-semibold text-[22px] text-[#b2b3bd] leading-[22px]"><FaRegThumbsDown /></button>
        </div>
