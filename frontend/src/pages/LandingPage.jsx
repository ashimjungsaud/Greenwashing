    ...
    return (
        <div>
            <div className="h-screen  w-full relative">
                ...
                <div className='ml-10'>
                <Link to='Information' className="bg-primary font-epilogue font-semibold text-[20px] leading-[26px] text-white min-h-[52px] px-4 py-4 rounded-[10px]" spy={true} smooth={true} offset={50} duration={500}>Learn more</Link>
                </div>
            </div>

            <div>
                <ContentSection1 id="Information" img={img1} heading="What is Greenwashing ?" para="Greenwashing isn't about cleaning your lawn—it's about misleading marketing. Companies use it to make you think their products are environmentally friendly when they aren't." />
